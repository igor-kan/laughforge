# Contributing to laughforge

Thank you for your interest in contributing to laughforge! This document provides guidelines and instructions for contributing to this project.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/laughforge.git
   cd laughforge
   ```
3. **Add the upstream remote**:
   ```bash
   git remote add upstream https://github.com/igor-kan/laughforge.git
   ```
...
By contributing to laughforge, you agree that your contributions will be licensed under the project's [MIT License](LICENSE).
